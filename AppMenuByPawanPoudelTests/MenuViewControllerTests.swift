...
class MenuViewControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        assert(menuViewController?.tapHandlerBuilder != nil,"")
    ...
    func swizzleNotificationHandler() {
        ...
        var testMethod: Method = class_getInstanceMethod(object_getClass(menuViewController), "testImpl_didSelectMenuItemNotification:")
