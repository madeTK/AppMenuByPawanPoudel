...
class MenuTableDefaultDataSourceTests: XCTestCase {
    ...
    func testReturnsOneRowForOneMenuItem() {
        let numberOfRows = dataSource!.tableView(fakeTableView, numberOfRowsInSection:0)
    ...
    func testReturnsOnlyOneSection() {
        let numberOfSections = dataSource!.numberOfSectionsInTableView(fakeTableView)
    ...
    func testEachCellContainsTitleForRespectiveMenuItem() {
        ...
        let cell = dataSource!.tableView(fakeTableView, cellForRowAtIndexPath: firstMenuItem)
